...
for i_episode in range(num_episodes):
    ...
    for t in count():
        ...
        action = env.action_space[int(action_index)]
        ...
        if done:
            print("episode number: {}, reward: {}".format(i_episode, episode_total_reward))
            episode_durations.append(episode_total_reward)
            plot_durations()
            break
